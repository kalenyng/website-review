export const environment = {
  firebase: {
    ...
    databaseURL: 'https://websitereview-817d4-default-rtdb.europe-west1.firebasedatabase.app',
    projectId: 'websitereview-817d4',
    storageBucket: 'websitereview-817d4.appspot.com',
    messagingSenderId: '243157984622',
    appId: '1:243157984622:web:e2c53e4a7aaf450aa8cd7f',
    measurementId: 'G-81L488P2LT',
  },
};
